...
| MySQL / PostgreSQL base stack | [Pull Docker Images](image-pull.md) → [Deploy Database Services](service-deployment.md) (extended scenarios; not required for Semantic Service) |
