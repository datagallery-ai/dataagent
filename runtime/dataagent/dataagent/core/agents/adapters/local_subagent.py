...
# ============================================================================
"""Local native DataAgent adapter for pending Job-path execution."""
...
class LocalSubagentAdapter:
    """Run a registered DataAgent subagent via ``sub_agent_entry`` in a background job."""
