...
# ============================================================================
"""
Agent current-context formatting utilities.

This module contains pure helpers retained for context-state rendering while the
context subsystem is migrated.
"""
...
def format_one_message(msg: Any) -> str:
    ...
    # 2) 持久化/示例：dict 形态（例如 agent state JSON）
...
def build_current_context(messages: Any) -> str:
    """
    将 messages 格式化为 Agent 使用的 current_context 字符串。
