...
| `clickhouse_table` | `uri` = `clickhouse://<output_database>/<table>`，`name` = `<output_database>.<table>` | 全部 `step1_sampled_*` 交付表 |
...
```json
{
  ...
  "artifacts": [
    ...
    {"kind": "clickhouse_table", "uri": "clickhouse://<output_database>/step1_sampled_<表1>", "name": "<output_database>.step1_sampled_<表1>"},
    {"kind": "clickhouse_table", "uri": "clickhouse://<output_database>/step1_sampled_<表2>", "name": "<output_database>.step1_sampled_<表2>"}
  ]
}
```
