import type { SessionIntent, TaskRelation } from "@datafoundry/agent-runtime";
  ...
  try {
    ...
    return active
      ? {
          ...
          protocolId: active.protocol_id,
          protocolVersion: active.protocol_version,
          intentText: active.intent_text
        }
      : undefined;
  } catch (error) {
